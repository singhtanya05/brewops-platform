      ...
      <div className="bg-card w-[420px] rounded-[24px] shadow-[0_20px_40px_rgba(0,0,0,0.2)] p-8 relative border border-white/60 animate-in zoom-in-95 duration-200 flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          <button 
            ...
            disabled={isProcessing}
            className="w-full py-3.5 mt-2 rounded-[16px] bg-red-100 text-red-600 font-bold text-[15px] shadow-[var(--shadow-clay-button)] hover:opacity-90 active:scale-95 transition-all"
          >
            Simulate Decline
          </button>
